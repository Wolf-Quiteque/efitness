...
jQuery(window).on("load", function () {
  jQuery(document).on("click", ".theme-color", function () {
    jQuery(".skin").attr(
      "href",
      "assets/css/skin/" + jQuery(this).data("color-theme") + ".css"
    );
  ...
  jQuery.each(themeOption, function (index, themeOptionItem) {
    ...
    if (themeOptionItemValue != "" && themeOptionItemValue != "1") {
      if (themeOptionItem == "themeStandardColor") {
        ...
        jQuery(".skin").attr(
          "href",
          "assets/css/skin/" + themeOptionItemValue + ".css"
        );
        ...
        if (
          ...
          jQuery(".layout-view li").removeClass("active");
          jQuery(".layout-view ." + themeOptionItemValue + " ").addClass(
            "active"
          );
        }
        ...
        jQuery('.bg-color-switcher [dir="' + themeOptionItemValue + '"]')
          .parent()
          .addClass("active");
      } else if (
